            ...
            <div>
                ...
                <div className="history">
                    ...
                    <div className="foundersInfo">
                        <img src="assets/img/foundersImage.jpg" alt=""/>
                ...
                <div className="imagesContainer">
                    ...
                    <div className="images">
                        <figure className="image">
                            <img src="assets/img/chance.jpg" alt="" />
                        </figure>
                        <figure className="image">
                            <img src="assets/img/dreams.jpg" alt="" />
                        </figure>
                        <figure className="image">
                            <img src="assets/img/iz.jpg" alt="" />
                        </figure>
                        <figure className="image">
                            <img src="assets/img/p-t-1.jpg" alt="" />
                        </figure>
                        <figure className="image">
                            <img src="assets/img/p-t-4.jpg" alt="" />
                        </figure>
                        <figure className="image">
                            <img src="assets/img/p-t-7.jpg" alt="" />
                        </figure>
                    </div>
                </div>
                ...
                <footer id='footer' className='footer-container container-brand-dark'>
                  ...
                  <img className='footer-image' src='/assets/img/footer-hands.png' />
                </footer>
            </div>
        )
    }
